...
import {apiGetMembersTransactionHistory} from "../services";
...
export const Component = () => {
  ...
  const {data, isLoading} = useQuery({
    queryFn: () => apiGetMembersTransactionHistory(page, limit, search),
    queryKey: ["admin-get-members-transaction-history", path, page, limit, search],
  });
  ...
  return (
    <TransitionPage>
      <div className='w-[450px] max-w-full'>
        <Search placeholder='Search in Transaction History' />
      </div>
