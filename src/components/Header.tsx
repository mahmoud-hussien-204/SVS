...
const Header = () => {
  ...
  return (
    <header className='fixed end-0 start-0 top-0 z-40 flex h-header-height-with-padding items-center justify-between px-container-padding pt-1.5rem backdrop-blur-md duration-150 peer-checked:start-header-start lg:start-header-start lg:peer-checked:start-0'>
